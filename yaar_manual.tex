...
\subsection{Example Measurement Result}

Figure~\ref{fig:test_example} shows a representative measurement obtained using the internal simulation mode with a non-integer tone frequency, added harmonic distortion, and elevated noise floor.
