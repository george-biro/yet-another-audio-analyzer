...
\begin{table}[H]
    ...
    \hline
    Q1 &  12.83V  &   12.16V & 30.4V  \\
    \hline
    Q2 &  25.6V  &  24.95V & 29.99V\\
    \hline
	\end{tabular}
\end{table}
...
The measured voltages were generally consistent with the service manual. However, the published emitter voltage for Q701/Q702 appears to be erroneous, since the listed base-emitter difference would be unrealistically low for a silicon transistor. The measured values are physically more plausible and consistent with normal transistor operation.
