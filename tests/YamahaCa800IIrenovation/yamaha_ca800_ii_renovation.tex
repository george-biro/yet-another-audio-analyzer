...
\begin{table}[H]
	\centering
	\caption{Function Board Voltages}
	\label{tab:function_board_voltages}
	\begin{tabular}{|l|l|l|l|}
    \hline
 \textbf{Ref.} & \textbf{B} & \textbf{E} & \textbf{C} \\
    \hline
    TR401 & 0.66V   & 0.08V  & 5.09V  \\
    TR402 & 0.65V   & 0.08V  & 5.08V  \\
    TR403 & 5.07V   & 4.52V  & 26.84V  \\
    TR404 & 5.04V   & 4.5V  & 27.38V  \\
    TR405 & 4.5V   & 3.89V  & 27.08V  \\
    TR406 & 4.49V   & 3.88V  & 27.54V  \\
    TR407 & 27.2V   & 26.63V  & 49.5V  \\
    TR408 & 27.6V   & 27.08V  & 49.5V  \\
	\end{tabular}
\end{table}
