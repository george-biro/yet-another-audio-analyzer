...
\begin{table}[H]
 ...
 \textbf{Ref.} & \textbf{B} & \textbf{E} & \textbf{C} \\
    ...
    \hline
    TR608 (npn) & 140mV (100mV) & 3mV (0V)  & 1.55V (1.5V)   \\
                & 280mV (200mV)  & 3mV (0V) & 2.2V (2V)  \\
    \hline
    TR609 (pnp) & -140mV (-200mV) & 3mV  & -0.95V (-1V)  \\
                & -330mV  & 3mV  & -1.46V (-1.5V) \\
    \hline
    TR610 (npn) & 1.82V (1.78V) & 1.25V  & 43.24V (43V)  \\
                & 2.41V (2.4V) & 1.79V    & 17.9V   \\
    \hline
    TR611 (pnp) & -1.26V (-1.2V) & -0.66V (-0.6V) & -43.37V (-43V)  \\
                & -1.78V (-1.74V) & -1.13V (-1V) & -17.9V (-17.0V) \\
    \hline
