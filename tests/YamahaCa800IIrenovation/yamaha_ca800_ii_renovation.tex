...
\begin{table}[H]
	\centering
	\caption{Power Supply Board Repair Log}
	\label{tab:repair_log_tone_control_board}
	\begin{tabular}{|l|l|l|}
		\hline
		\textbf{Ref.} & \textbf{Original} & \textbf{Replacement} \\
		\hline
		TR701 & 2SA671S   & BD140-16 (OnSemi) \\
                TR704 & 2SC1061S  & BD139-16 (OnSemi) \\
                TR705, TR707, TR709 & 2SC458 & KSC1845F (OnSemi )\\
                C705, C706, C707, C708 &   & Panasonic EEU-FS2A221 \\
                C709, C710 & &  Panasonic EEUFR1J101L \\ 
                D703, D706 &  & 30V zener \\
                D704, D705 &  & 20V zener \\ 
		\hline
	\end{tabular}
...
The function board contains the phono preamplifier and input-selection circuitry. The capacitance and ESR of all electrolytic capacitors were measured, and capacitors were replaced whenever modern components provided significantly lower ESR values. Some hum was present on this board, originating from the 2SC1345 transistors. After replacing these transistors, their complementary counterparts also had to be replaced.

Further measurements and simulations showed that, when used with a moving-magnet cartridge from the same era (\textit{Technics EPC-207C}), which has an internal inductance of approximately 400\,mH and an internal resistance of approximately 400\,$\Omega$, the preamplifier did not perform optimally. In addition, the original configuration resulted in unsatisfactory sound quality. Consequently, modifications were made to the RIAA capacitors (C413, C414, C415, and C416). As a result, the modified RIAA circuit exhibits very low phase and gain errors, and the overall sound quality was significantly improved. The modified circuit was also simulated, and the results are shown in Fig.~\ref{fig:simu}.
...
During testing, the original power switch was found to be defective. A new C \& K Switches V80102SS05Q was installed and positioned in the original location. In addition, a TDK B72214S271K101 (S14K275) varistor was added for surge protection.
...
\paragraph{Documentation Note}
In the original schematics, the transistor at position TR605 is incorrectly listed as 2SC1174-2. The actual installed component is 2SC1124.
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|}
		...
		TR601, TR603, TR604 & 2SA673WL4,5 & KSA992F (OnSemi HFE $\approx$ 350) \\
                TR602 & 2SC1571G & KSA1845F (OnSemi HFE $\approx$ 550) \\
                TR605 & 2SC1124-2 & TTC004B (Toshiba HFE $\approx$ 180) \\
                TR607 & 2SC458C & KSC1815Y (OnSemi HFE $\approx$ 130)\\
                TR610 & 2SC1124-2 & TTC004B  (Toshiba HFE $\approx$ 180) \\
                TR611 & 2SA706 3 & TTA004B (Toshiba HFE $\approx$ 180) \\
                R630, R631 & 0.47Ohm 5W & MOR500SJTB-0R47-Hitano (measured both 0.462..3 Ohm) \\
                \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
 ...
 \textbf{Ref.} & \textbf{B} & \textbf{E} & \textbf{C} \\
    \hline
    TR601 (pnp) & 30mV (20mV) & 0.603mV (0.5V) & -51.26V (-53V)  \\
    \hline
    TR602 (npn) & -51.3V (-53.5V) & -51.97V (-54V) & -51.27V (-53V)  \\
    \hline
    TR603 (pnp) & 45.5V (47V) & 46.078V (47.5V) & 0.59V (0.5V) \\
    \hline
    TR604 (pnp) & 34mV (15mV) & 0.6V (0.5V) & -51.3V (-53V) \\
    \hline
    TR605 (npn) & -51.55V (-52V) & -52.08V (-53V) & -1.19V (-1.2V) \\
                & -51.2V (-52V)  & -52.08V (-53V) & -1.76V (-1.7V) \\
    \hline
    TR606 (pnp) & 1.11V (1V) & 1.77V (1.8V) & -1.18V (-1.2V) \\
                & 1.74V (1.7V) & 2.39V  & -1.73V (-1.7V) \\  
    \hline
    TR607 (npn) & -0.55V (-0.6V)  & -1.17V (-1.2V) & 1.08V (1V) \\
               & -1.11V (-1V)  & -1.72V (-1.7V) & 1.71V (1.7V) \\
    \hline
    TR608 (npn) & 84mV (100mV) & 2.8mV (0V)  & 1.52V (1.5V)   \\
                & 260mV (300mV)  & 2.6mV (0V) & 2.12V (2V)  \\
    \hline
    TR609 (pnp) & -130mV (-200mV) & 1.8mV  & -0.90V (-1V)  \\
                & -330mV  & 1.8mV  & -1.46V (-1.41V) \\
    \hline
    TR610 (npn) & 1.82V (1.78V) & 1.25V  & 43.8V (43V)  \\
                & 2.41V (2.4V) & 1.79V    & 18.3V   \\
    \hline
    TR611 (pnp) & -1.26V (-1.2V) & -0.66V (-0.6V) & -43.9V (-43V)  \\
                & -1.78V (-1.74V) & -1.13V (-1V) & -18.24V (-17.0V) \\
    \hline
    TR612 (npn) & 0.64V (0.6V) & 24mV (23mV) & 43.3V \\
                & 1.1V (1V) & 0.4V (0.4V) & 18.3V \\
    \hline
    TR613 (pnp) & -0.63V (-0.6V) & -13.7mV (-30mV)  & -43.9V   \\
                & -1.1V (-1V) & -0.41V (-0.44V)  & -18.24V  \\
    \hline
	\end{tabular}
\end{table}

Main amplifier tested with preamp disconnected and inputs shorted; residual output noise approx. 1 mV (scope-limited broadband noise), considered within specification.
...
\begin{table}[H]
 ...
 \textbf{Ref.} & \textbf{B} & \textbf{E} & \textbf{C} \\
    \hline
    TR601 (pnp) & 16mV (20mV)  & 595mV (0.5V)  & -51.42V  (-53V)  \\
    \hline
    TR602 (npn) & -51.87V (-53.5V)  & -52.25V (-54V)  & -51.17V (-53V) \\
    \hline
    TR603 (pnp) & 45.09V (47V) &  45.6V (47.5V) & 0.56V (0.5V)  \\
    \hline
    TR604 (pnp) & 24mV (20mV)  & 0.59 (0.5V) & -51.22V  (-53V) \\
    \hline
    ...
    \hline
    TR612 (npn) & 0.63V (0.6V) & 14mV (24mV) & 43.5V \\
                & 1.12V (1V) & 0.4V (0.41V) & 16.2V \\
    \hline
    TR613 (pnp) & -0.648V (-0.6V) & -20mV (-40mV)  & -43.6V  \\
...
Overall, the phono stage demonstrates very good post-restoration behavior. Low-frequency distortion remains exceptionally low, with THD values near \(0.03\%\) in both channels. Across the midband and upper audio range, THD generally remains between \(0.03\%\) and \(0.07\%\), while THD+N rises moderately due to the higher gain structure and broader noise contribution of the phono equalizer stage. Harmonic spectra are dominated by low-order components, and no signs of instability or oscillation were observed during testing.
